 ...
 */
 window.addEventListener('load', () => {
  ...
  // retrieve added bullets
  let bullets = [];
  for (let i = 0; i < localStorage.length; i++) {
    let key = localStorage.key(i);
      if (key.startsWith("mon")) {
          bullets.push(JSON.parse(localStorage.getItem(key)));
      }
  ...
  bullets.sort((a, b) => (a.id > b.id) ? 1 : -1);
  console.log(bullets);
...
document.getElementById("mon-add").addEventListener('click', () => {
  ...
  let list = document.getElementById("mon").getElementsByTagName('ul')[0];
  dropDown.id = "mon" + list.childNodes.length;
...
document.getElementById("tue-add").addEventListener('click', () => {
  ...
  dropDown.appendChild(item);
  dropDown.appendChild(myDropDown);
  let list = document.getElementById("tue").getElementsByTagName('ul')[0];
  dropDown.id = "tue" + list.childNodes.length;
  list.appendChild(dropDown);
  saveToLC(dropDown);
  console.log(dropDown);
});

document.getElementById("wed-add").addEventListener('click', () => {
  let item = document.createElement('li');
  item.contentEditable = "true";
  item.innerHTML = "ADD ENTRY";
  item.classList.add('task-list');
  ...
  dropDown.appendChild(item);
  dropDown.appendChild(myDropDown);
  let list = document.getElementById("wed").getElementsByTagName('ul')[0];
  dropDown.id = "wed" + list.childNodes.length;
  list.appendChild(dropDown);
  saveToLC(dropDown);
  console.log(dropDown);
});

document.getElementById("thu-add").addEventListener('click', () => {
  let item = document.createElement('li');
  item.contentEditable = "true";
  item.innerHTML = "ADD ENTRY";
  item.classList.add('task-list');
  ...
  dropDown.appendChild(item);
  dropDown.appendChild(myDropDown);
  let list = document.getElementById("thu").getElementsByTagName('ul')[0];
  dropDown.id = "thu" + list.childNodes.length;
  list.appendChild(dropDown);
  saveToLC(dropDown);
  console.log(dropDown);
});

document.getElementById("fri-add").addEventListener('click', () => {
  let item = document.createElement('li');
  item.contentEditable = "true";
  item.innerHTML = "ADD ENTRY";
  item.classList.add('task-list');
  ...
  dropDown.appendChild(item);
  dropDown.appendChild(myDropDown);
  let list = document.getElementById("fri").getElementsByTagName('ul')[0];
  dropDown.id = "fri" + list.childNodes.length;
  list.appendChild(dropDown);
  saveToLC(dropDown);
  console.log(dropDown);
});

document.getElementById("sat-add").addEventListener('click', () => {
  let item = document.createElement('li');
  item.contentEditable = "true";
  item.innerHTML = "ADD ENTRY";
  item.classList.add('task-list');
  ...
  dropDown.appendChild(item);
  dropDown.appendChild(myDropDown);
  let list = document.getElementById("sat").getElementsByTagName('ul')[0];
  dropDown.id = "sat" + list.childNodes.length;
  list.appendChild(dropDown);
  saveToLC(dropDown);
  console.log(dropDown);
});

document.getElementById("sun-add").addEventListener('click', () => {
  let item = document.createElement('li');
  item.contentEditable = "true";
  item.innerHTML = "ADD ENTRY";
  item.classList.add('task-list');
  ...
  dropDown.appendChild(item);
  dropDown.appendChild(myDropDown);
  let list = document.getElementById("sun").getElementsByTagName('ul')[0];
  dropDown.id = "sun" + list.childNodes.length;
  list.appendChild(dropDown);
  saveToLC(dropDown);
  console.log(dropDown);
});
